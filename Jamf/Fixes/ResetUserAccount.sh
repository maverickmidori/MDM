...
### Notes: Original intent for script is lost   ###
###################################################
# This appears to be a script that resets an admin/standard account password via script. This can be done by a standard user. Potential backdoor to open in Self Service assigned to technician group. If GUI fails? I cannot recall the intent this was created for, potentially Self Admins running a reset?
